<template>
    ...
    <div class="collapse navbar-collapse  w-auto" style="height: unset; margin-bottom: 10px;" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <router-link class="nav-link text-white" :to="{name: 'adminProfile'}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <router-link class="nav-link text-white" :to="{name: 'adminUsers'}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10" style="color: #FFFF00 !important;">people</i>
            </div>
            <span class="nav-link-text ms-1" style="color: #FFFF00 !important;">Users</span>
          </router-link>
        </li>
      </ul>
    </div>
